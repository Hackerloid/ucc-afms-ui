...
export default function Reports() {
  ...
  return (
    <div className="workspace-page">
      ...
      {/* Analytics Cards */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5 xl:gap-6 2xl:gap-8 animate-slide-up" style={{ animationDelay: '200ms' }}>
                  ...
                  <tr key={idx} className="hover:bg-white transition-all group/row cursor-pointer">
                    ...
                    <td className="px-8 py-5 text-right">
                      <div className="flex justify-end gap-2">
                        <button className="px-3 py-2 rounded-xl border border-gray-200 text-[10px] font-black uppercase tracking-widest text-gray-700 hover:bg-gray-50 transition-all">
                          Review
                        </button>
                        <button className="px-3 py-2 rounded-xl border border-gray-200 text-[10px] font-black uppercase tracking-widest text-ucc-blue hover:bg-ucc-blue/5 transition-all">
                          Edit
                        </button>
                        <button className="px-3 py-2 rounded-xl border border-red-100 bg-red-50 text-[10px] font-black uppercase tracking-widest text-red-700 hover:bg-red-100 transition-all">
                          Delete
                        </button>
                      </div>
                    </td>
      ...
      {showReportModal && (
        <div className="modal-overlay animate-fade-in">
          ...
          <div className="modal-shell max-w-4xl animate-slide-up">
            {/* Modal Header */}
            <div className="modal-header bg-gradient-to-br from-gray-900 to-black text-white overflow-hidden">
              <div className="absolute top-0 right-0 w-64 h-64 -mr-32 -mt-32 bg-ucc-blue/20 rounded-full blur-3xl"></div>
              <div className="relative z-10">
                <div className="flex items-center gap-2 mb-2">
                  <span className="px-2 py-1 rounded bg-white/10 text-white text-[9px] font-black uppercase tracking-widest backdrop-blur-md">Report Builder</span>
                  <span className="w-1.5 h-1.5 rounded-full bg-ucc-gold animate-pulse"></span>
                </div>
                <h2 className="modal-title">Generate an <span className="text-ucc-blue">Analytics Report</span></h2>
                <p className="text-[11px] text-gray-300 mt-3 font-medium max-w-xl leading-relaxed">
                  Choose the data source, date range, and fields to include in this report.
                </p>
              </div>
              <button 
              ...
              <form className="space-y-10">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="md:col-span-2">
                    <label className="block text-[10px] font-black text-gray-500 uppercase tracking-widest mb-2 ml-1">Report Title</label>
                    <input 
                      type="text" 
                  ...
                  <div>
                    <label className="block text-[10px] font-black text-gray-500 uppercase tracking-widest mb-2 ml-1">Data Source</label>
                  ...
                  <div>
                    <label className="block text-[10px] font-black text-gray-500 uppercase tracking-widest mb-2 ml-1">Date Range</label>
                ...
                <div className="space-y-6 pt-4">
                  <h3 className="text-xs font-black text-gray-400 uppercase tracking-[0.25em] flex items-center gap-3">
                    <Filter size={18} className="text-ucc-blue" /> Data Fields
                  </h3>
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    {['Document Metadata', 'User Activity', 'Department Activity', 'Workflow Timing', 'Resource Usage', 'Security Logs'].map(dim => (
                ...
                <div className="p-8 bg-blue-50/30 border border-blue-100 rounded-[2rem] flex flex-col items-center text-center">
                  ...
                  <h4 className="text-sm font-black text-gray-900 uppercase tracking-widest">Share with Leadership</h4>
                  <p className="text-[11px] text-gray-500 mt-2 font-medium max-w-sm leading-relaxed">Automatically send this report to the Vice-Chancellor's office and the selected leadership team after generation.</p>
                </div>
              </form>
            </div>
            ...
            <div className="modal-footer">
              ...
              <button className="px-10 py-3.5 bg-black text-white text-[10px] font-black uppercase tracking-[0.2em] rounded-2xl hover:bg-ucc-blue shadow-xl transition-all flex items-center gap-3">
                Generate Report <BarChart3 size={16} />
              </button>
            </div>
          </div>
          </div>
